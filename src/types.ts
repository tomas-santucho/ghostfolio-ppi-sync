...
export interface NormalizedTransaction { id:string; accountId:string; type:TransactionType; symbol?:string; isin?:string; market?:string; dataSource?:string; instrumentType?:string; currency:string; date:Date; quantity?:string; unitPrice?:string; fee?:string; externalId?:string; sourceBalance?:string; description?:string; source:'ppi'; }
