...
test('validates and maps configuration', () => expect(loadConfig({...env,SYNC_TO_DATE:'2024-01-31'})).toMatchObject({ dryRun:false, syncFromDate:new Date('2024-01-01T00:00:00.000Z'), syncToDate:new Date('2024-01-31T23:59:59.999Z'), ppi:{orderEnrichment:false} }));
